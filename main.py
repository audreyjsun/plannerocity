...
baseurl = "https://api.yelp.com/v3/businesses/search"
def get_shops(location = "", radius = 16000, term = "", limit = 20, price = "", \
              api_key = "C7mDFaAms-ANWBY6RNRNHbZcoOV024SjHsNLfMLnn0L_zQp3eGGhCGPqeEeEhGDfIzRz6PKACiyExV_Ffg736Bs_9NjMMhcmAEabW_tZWFz11egieQtHuLfLZMa1X3Yx"):
    shops = {}
